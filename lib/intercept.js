...
function isEnabledForNetConnect(options) {
  ...
  var enabled = allowNetConnect && (allowNetConnect.test(options.host) || allowNetConnect.test(options.path));
...
function overrideClientRequest() {
  ...
  function OverriddenClientRequest(options, cb) {
    ...
    if (isOn() && !isEnabledForNetConnect(options) && hasHadInterceptors(options)) {
